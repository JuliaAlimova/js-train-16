...
function validateUserInput(userInput) {
  ...
  if (!userInput.username) console.error("Помилка: ім'я користувача відсутнє!");
  if (!userInput.password) console.error("Помилка: пароль відсутній!");
  ...
  // Перевірка довжини паролю чи менше вона ніж 8,якщо так виводимо повідомлення про потенційну проблему з текстом "Попередження: пароль має бути довшим за 8 символів!"
}
